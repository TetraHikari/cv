    ...
    return (
        <div className="Home mt-10 w-max text">
            <div className="flex-row w-fit mb-10">
                <div className="flex justify-start animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-black pr-5 text-5xl text-black font-bold">PEERANAT PATARAKITTISOPOL</div>
            </div>
            <div className="Home-content flex justify-start ">
